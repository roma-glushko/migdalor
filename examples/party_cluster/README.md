...
<p align="center">
<img src="/docs/party-cluster-node-api.png" width="100%" alt="The Party Cluster - An example of using Migdalor to implement peer discovery in Kubernetes cluster" />
</p>
